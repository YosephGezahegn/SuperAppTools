...
class SuperApp(ctk.CTk):
    def __init__(self):
        ...
        self.btn_renamer = ctk.CTkButton(self.sidebar, text="Batch Renamer",
                                       fg_color="transparent", border_width=1,
                                       command=self.show_renamer)
        self.btn_renamer.grid(row=4, column=0, padx=20, pady=10)
        ...
        self.frames["renamer"] = BatchRenamerFrame(self.container)
    ...
    def show_cleaner(self):
        ...
        self.btn_renamer.configure(fg_color="transparent")
    ...
    def show_renamer(self):
        self.active_frame("renamer")
        self.btn_renamer.configure(fg_color=["#3B8ED0", "#1F6AA5"])
        self.btn_cleaner.configure(fg_color="transparent")
        self.btn_scaler.configure(fg_color="transparent")
        self.btn_recorder.configure(fg_color="transparent")
